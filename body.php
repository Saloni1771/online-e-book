  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="img/ban1.jpg" alt="Los Angeles" style="width:100%;">
      ...
      <div class="item">
        <img src="img/ban4.jpg" alt="New York" style="width:100%;">
        
      </div>
      <div class="item">
        <img src="img/ban5.jpg" alt="New York" style="width:100%;">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=78"><div class="shop">
							<div class="shop-img">
								<img src="./img/Shopp1.png" alt="">
							</div>
							<div class="shop-body">
								<h3>NCERT<br>Collection</h3>
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=72"><div class="shop">
							<div class="shop-img">
								<img src="./img/Shopp2.png" alt="">
							</div>
							<div class="shop-body">
								<h3>Reference Book<br>Collection</h3>
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab1">NCERT</a></li>
									<li><a data-toggle="tab" href="#tab1">Question Bank</a></li>
									<li><a data-toggle="tab" href="#tab1">Ncert Reference</a></li>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab2">Text Books</a></li>
									<li><a data-toggle="tab" href="#tab2">Reference Books</a></li>
									<li><a data-toggle="tab" href="#tab2">Question Bank</a></li>
									<li><a data-toggle="tab" href="#tab2">Novels</a></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="products-widget-slick" data-nav="#slick-nav-3">
							...
							<div id="get_product_home2">
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Novels</p>
										<h3 class="product-name"><a href="#">Sherlock Homes</a></h3>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Novels</p>
										<h3 class="product-name"><a href="#">Dan Brown Collection</a></h3>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Novels</p>
										<h3 class="product-name"><a href="#">Sherlock Series</a></h3>
										<h4 class="product-price">$280.00 <del class="product-old-price">$300.00</del></h4>
									</div>
								</div>
								<!-- product widget -->
